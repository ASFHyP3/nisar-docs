...
The GUNW product is an L2 product derived from the [RIFG](#rifg-product-overview) and [RUNW](#runw-product-overview) products by geocoding the unwrapped phase and associated data layers (i.e., coherence magnitude, ionospheric phase screen) on a geographical grid at 80 m posting. Only nearest-neighbor (12-day) GUNW products are generated as a part of the NISAR mission.  
