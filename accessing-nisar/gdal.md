...
To use commands generated by the snippet exporter, you must install GDAL. The process for installing GDAL differs based on the operating system installed on your computer, or the compute environment in which you wish to run the exported GDAL snippets.
