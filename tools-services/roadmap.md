...
|---------------------------------------------------------|----------------------------|-------------------------------------------------------------------------------------------|--------------------|----------------|
| NISAR GCOV Variable Subsetting                          | [Harmony](#ed-harmony)     | Extract variable(s) from an HDF5 file, and save as Cloud-Optimized GeoTIFF(s)             | In Progress        | June 2026      |
...
| NISAR GCOV Variable Spatial Subsetting and Reprojection | [Harmony](#ed-harmony)     | Clip variable COG to specified spatial extent and optionally change the output projection | Pending            | Q4 2026        |
