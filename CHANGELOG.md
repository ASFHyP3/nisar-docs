...
### Added
- Information regarding GDAL snippet extracter
- Windows snippets in GDAL page

## [0.4.34]

### Added
- Warning for NISAR data gap
...
- Updated QGIS page to announce support for NISAR starting with version 4.0 and highlight netCDF driver prepend option when adding data
